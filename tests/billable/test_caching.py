...
@pytest.mark.parametrize(
    ...
    [
        ...
        "./example_workflows/debug_examples/together_debate.py",
        "./example_workflows/debug_examples/anthropic_async_debate.py",
        "./example_workflows/debug_examples/anthropic_debate.py",
        ...
        "./example_workflows/debug_examples/openai_async_debate.py",
        "./example_workflows/debug_examples/openai_debate.py",
        ...
        "./example_workflows/debug_examples/vertexai_debate.py",
        "./example_workflows/debug_examples/vertexai_debate_async.py",
    ],
)
