...
@pytest.mark.parametrize(
    ...
    [
        ...
        "./example_workflows/debug_examples/together/together_debate.py",
        "./example_workflows/debug_examples/anthropic/async_debate.py",
        "./example_workflows/debug_examples/anthropic/anthropic_debate.py",
        ...
        "./example_workflows/debug_examples/openai/openai_debate.py",
        ...
        "./example_workflows/debug_examples/google/vertexai_adebate.py",
        "./example_workflows/debug_examples/google/vertexai_debate_async.py",
    ],
)
