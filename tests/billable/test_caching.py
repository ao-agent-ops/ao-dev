...
@pytest.mark.parametrize(
    ...
    [
        ...
        "./example_workflows/debug_examples/together/add_numbers.py",
        "./example_workflows/debug_examples/anthropic/async_add_numbers.py",
        "./example_workflows/debug_examples/anthropic/add_numbers.py",
        ...
        "./example_workflows/debug_examples/openai/async_add_numbers.py",
        "./example_workflows/debug_examples/openai/add_numbers.py",
        ...
        "./example_workflows/debug_examples/google/add_numbers.py",
        "./example_workflows/debug_examples/google/add_numbers_async.py",
    ],
)
