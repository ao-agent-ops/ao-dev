...
export const STACK_LAYER_SPACING = 12;  // Stack layout vertical gap between nodes
...
// Configurable band colors by level and side - all white for now
// Previous colored scheme commented out:
...
export const BAND_COLORS: Record<number, { left: string; right: string }> = {
	1: { left: '#FFFFFF', right: '#FFFFFF' },
	2: { left: '#FFFFFF', right: '#FFFFFF' },
	3: { left: '#FFFFFF', right: '#FFFFFF' },
	4: { left: '#FFFFFF', right: '#FFFFFF' },
	5: { left: '#FFFFFF', right: '#FFFFFF' },
};
