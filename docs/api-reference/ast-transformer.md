...
::: ao.server.ast_transformer.rewrite_source_to_code
    options:
...
::: ao.server.ast_transformer.exec_func
    options:
      show_root_heading: true
      show_source: true
...
::: ao.server.ast_transformer.taint_fstring_join
    options:
      show_root_heading: true
      show_source: true
...
::: ao.server.ast_transformer.taint_format_string
    options:
      show_root_heading: true
      show_source: true
...
::: ao.server.ast_transformer.taint_percent_format
    options:
      show_root_heading: true
      show_source: true
...
::: ao.server.ast_transformer.is_pyc_rewritten
    options:
      show_root_heading: true
      show_source: true
